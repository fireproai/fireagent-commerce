      ...
      <div className="mx-auto w-full max-w-7xl px-3 sm:px-4">
        <div className="flex items-center justify-between gap-2 py-2.5">
          ...
          <div className="flex min-w-0 items-center gap-2.5">
            <Link href="/" className="relative -top-px flex h-9 items-center">
              <Image
          ...
          <div className="flex min-w-0 items-center gap-2">
            <form
              action="/search"
              className="w-[280px] max-w-[45vw] sm:w-[340px] md:w-[380px]"
            >
              <div className="flex items-center gap-2">
                <input
                  name="q"
                  className="h-9 w-full rounded-lg border border-neutral-200 bg-white px-3 text-sm leading-none outline-none focus:border-red-700 focus:ring-2 focus:ring-red-200 focus:ring-offset-0"
                  placeholder="Search by SKU or product name"
                  aria-label="Search"
                />
                <button
                  type="submit"
                  className="inline-flex h-9 shrink-0 items-center justify-center rounded-lg border border-neutral-200 bg-white px-3 text-sm font-medium leading-none text-neutral-800 hover:bg-neutral-50"
                >
                  Search
                </button>
              </div>
            ...
            <a
              href={loginUrl}
              className="hidden sm:inline-flex h-9 shrink-0 items-center rounded-lg border border-neutral-200 px-3 text-xs leading-none text-neutral-700 hover:bg-neutral-50"
            >
              Account / Login
            </a>
          </div>
        ...
        {/* MOBILE NAV (keeps your existing menu + modes available) */}

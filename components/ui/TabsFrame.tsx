        ...
        {tabs.map((tab, index) => {
          ...
          return (
            <button
              ...
              className={clsx(
                "relative rounded-t-lg px-3 py-2 text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-300 focus-visible:ring-offset-2 focus-visible:ring-offset-white",
                isActive
